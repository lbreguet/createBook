...
/***/ function(module, exports, __webpack_require__) {
	...
	var posts = __webpack_require__(38);
	var comments = __webpack_require__(42);
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://createbook-api.herokuapp.com'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var postUi = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUpTemplate = __webpack_require__(12);

	var changePasswordTemplate = __webpack_require__(32);

	var signUpShow = function signUpShow() {
	...
	var changePasswordShow = function changePasswordShow() {
	  var changePasswordHtml = changePasswordTemplate();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"sign-up\" class=\"sign-up\">\n  <fieldset>\n    <label class=\"email\">\n        Email\n        <input type=\"email\" name=\"credentials[email]\" class=\"signup-email\">\n  </label>\n    <br>\n    <label class=\"password\">\n        Password\n        <input id=\"password\" type=\"password\" name=\"credentials[password]\" class=\"signup-password\">\n  </label>\n    <br>\n    <label class=\"password_confirmation\">\n        Password <br>Confirmation\n        <input id=\"password_confirmation\" type=\"password\" name=\"credentials[password_confirmation]\" class=\"signup-password\">\n  </label>\n    <br>\n    <input type=\"submit\" name=\"submit\" value=\"Sign up!\">\n  </fieldset>\n</form>\n\n<h4 class=\"back-to-signin\">Back</h4>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"change-password\">\n  <fieldset>\n    <label class=\"old\">\n        Old password\n        <input type=\"password\" name=\"passwords[old]\" class=\"old-password\">\n  </label>\n\n    <label class=\"new\">\n        New password\n        <input type=\"password\" name=\"passwords[new]\" class=\"new-password\">\n  </label>\n\n    <input type=\"submit\" name=\"submit\" value=\"Change password!\">\n  </fieldset>\n</form>\n<br>\n<h4 class=\"back-to-menu\">Back</h4>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexPostsTemplate = __webpack_require__(34);
	var showPostTemplate = __webpack_require__(35);
	var createPostTemplate = __webpack_require__(37);

	var indexSuccess = function indexSuccess(data) {
	  var indexPostsHtml = indexPostsTemplate({ posts: data.posts });
	  var createPostHtml = createPostTemplate();
	...
	var showSuccess = function showSuccess(data) {
	  var showPostHtml = showPostTemplate({ post: data.post });
	  $('.content').empty().append(showPostHtml);
	  $('.create-css').empty();
	  $('.auth').empty();
	};

	var clearCreateForm = function clearCreateForm() {
	  $('.clear').val('');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "    <div>\n      <div data-id=\""
	    ...
	    + "\" class=\"btn-group post-destroy\">\n        <button type=\"button\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-danger\">\n          Delete\n        </button>\n      </div>\n\n      <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#myModal\" data-whatever=\"@mdo\" id=\"edit-modal\">Edit</button>\n\n      <div data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal\" id=\"myModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h4 class=\"modal-title\" id=\"myModalLabel\">Edit Post</h4>\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n            <span aria-hidden=\"true\">&times;</span>\n          </button>\n            </div>\n            <p class=\"update-failure\"></p>\n            <div class=\"modal-body\">\n              <form data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal-edit\" id=\"edit-post\">\n                <div class=\"form-group\">\n                  <label for=\"title-name\" class=\"form-control-label\">Title:</label>\n                  <br>\n                  <h3 data-title=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.title : stack1), depth0))
	    + "\" class=\"edit-title\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.title : stack1), depth0))
	    + "</h3>\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"message-text\" class=\"form-control-label\">Content:</label>\n                  <br>\n                  <textarea required=\"required\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.content : stack1), depth0))
	    + "\" class=\"edit-content\" name=\"post[content]\" value=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.content : stack1), depth0))
	    + "\" maxlength=\"282\" rows=\"7\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n                </div>\n                <button data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	  ...
	  return "<div class=\"post-show-content\" data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <div data-id='"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	    + "'>\n    <h3 class=\"show-title\" data-id='"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.id : stack1), depth0))
	    + "'>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.title : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.content : stack1), depth0))
	    + "</p>\n    </div>\n  </div>\n\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.post : depth0)) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "  <br>\n  <div class=\"index-comment\">"
	    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"../comments/index-comment","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "</div>\n  <br>\n  <h4 class=\"back-to-menu\">Back</h4>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <div data-postId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.post_id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n      <div data-postId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.post_id : stack1), depth0))
	    ...
	    + "</p>\n      </div>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = blockParams[0][0]) != null ? stack1.editable : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </div>\n    <br>\n";
	  ...
	  return "      <div>\n        <div data-id=\""
	    ...
	    + "\" data-postId=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.post_id : stack1), depth0))
	    + "\" class=\"btn-group comment-destroy\">\n          <button type=\"button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-postId=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.post_id : stack1), depth0))
	    + "\" class=\"btn btn-danger\">\n            Delete\n          </button>\n        </div>\n\n        <!-- <button data-id=\""
	    ...
	    + "\" data-postId=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.post_id : stack1), depth0))
	    + "\" class=\"modal-edit\" id=\"edit-comment\">\n                  <div class=\"form-group\">\n                    <label for=\"message-text\" class=\"form-control-label\">Content:</label>\n                    <br>\n                    <textarea required=\"required\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.body : stack1), depth0))
	    + "\" class=\"edit-body\" name=\"comment[body]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.body : stack1), depth0))
	    + "\" maxlength=\"175\" rows=\"5\">"
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.body : stack1), depth0))
	    + "</textarea>\n                  </div>\n                  <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-postId=\""
	  ...
	  return "\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.comments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  <div class=\"create-container\">\n    <h3 class=\"create-form\">Comment</h3>\n    <form data-id=\""
	    + alias2(((helper = (helper = helpers.post_id || (depth0 != null ? depth0.post_id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"post_id","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "\" id=\"create-comment\">\n      <textarea required=\"required\" data-id=\""
	    + alias2(alias3(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"form-control textarea clear\" name=\"comment[body]\" placeholder=\"Type here\" maxlength=\"175\" rows=\"5\"></textarea>\n      <br>\n      <button data-id=\""
	    + alias2(alias3(((stack1 = (depth0 != null ? depth0.comment : depth0)) != null ? stack1.post_id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn btn-default\">Publish</button>\n    </form>\n  </div>\n";
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<div class=\"create-container\">\n  <h3 class=\"create-form\">Share with Others</h3>\n  <form id=\"create-post\">\n    <label for=\"title-name\" class=\"form-control-label clear\">Title:</label>\n    <br>\n    <input required=\"required\" class=\"form-control clear\" type=\"text\" name=\"post[title]\" placeholder=\"Title\" maxlength=\"10\">\n    <br>\n    <label for=\"title-name\" class=\"form-control-label\">Content:</label>\n    <br>\n    <textarea required=\"required\" class=\"form-control clear\" name=\"post[content]\" placeholder=\"Type here\" maxlength=\"266\" rows=\"7\"></textarea>\n    <button type=\"button\" class=\"btn btn-default clear-form\" aria-label=\"Clear\">Clear Form</button>\n    <br>\n    <button type=\"submit\" class=\"btn btn-default\">Publish</button>\n  </form>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var commentsApi = __webpack_require__(39);
	var commentsUi = __webpack_require__(40);
	...
	var onGetPosts = function onGetPosts(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.searchPosts(data.post).then(ui.indexSuccess);
	  // .catch(ui.failure)
	};
	...
	var onShowPost = function onShowPost(event) {
	  ...
	  api.show(id).then(ui.showSuccess).then(function () {
	    return commentsApi.index(id);
	  }).then(function (data) {
	    return commentsUi.indexSuccess(data, id);
	  });
	  // .catch(ui.failure)
	};
	...
	var onUpdatePost = function onUpdatePost(event) {
	  ...
	  var data = getFormFields(event.target);
	  var id = event.target.dataset.id;
	  api.update(data, id).then(ui.updateSuccess).then(function () {
	    return onMenu();
	  });
	  // .catch(ui.failure)
	};

	var onDestroyPost = function onDestroyPost(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.destroy(id)
	  // .then(ui.success)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var create = function create(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/posts/' + id + '/comments',
	    method: 'POST',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexCommentTemplate = __webpack_require__(36);

	var indexSuccess = function indexSuccess(data, id) {
	  var indexCommentHtml = indexCommentTemplate({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchPosts = function searchPosts(data) {
	  var endpoint = '/posts?';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var postApi = __webpack_require__(41);
	var postUi = __webpack_require__(33);
	...
	var onCreateComment = function onCreateComment(event) {
	  ...
	  var data = getFormFields(event.target);
	  var id = event.target.dataset.id;
	  api.create(data, id).then(ui.createSuccess).then(function () {
	    return postApi.show(id);
	  }).then(postUi.showSuccess).then(function () {
	    return api.index(id).then(function (data) {
	      return ui.indexSuccess(data, id);
	    });
	...
	var onUpdateComment = function onUpdateComment(event) {
	  ...
	  var postId = $('.show-title').data('id');
	  api.update(data, id).then(ui.updateSuccess).then(function () {
	    return api.index(postId).then(function (data) {
	      return ui.indexSuccess(data, postId);
	    });
	  });
	  // .catch(ui.failure)
	};

	var onDestroyComment = function onDestroyComment(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  var postId = $('.show-title').data('id');
	  api.destroy(id).then(ui.deleteSuccess).then(function () {
	    return api.index(postId).then(function (data) {
	      return ui.indexSuccess(data, postId);
	    });
